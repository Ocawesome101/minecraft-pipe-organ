-- basic music tracker
-- this expects the lowest octave to be 0-12,
-- the middle octave to be the left side of 13-25,
-- and the high octave to be the right side of 13-25

local integrators = {}

for i=39, 51, 1 do
  integrators[i-39] = peripheral.wrap("redstoneIntegrator_"..i)
end
...
local function apply(notelist)
  ...
  for octave = 0, 2 do
    ...
    for note = 0, 12 do
      co[#co+1] = function()
        integrators[note].setOutput(sides[octave], not not notes[note])
      end
    end
  end
